...
public class TicketServiceImp implements TicketService {
    ...
    public Page<Ticket> findByParameters(int page, int count, String titulo, String status, String priority) {
        Pageable pageable = PageRequest.of(page,count);
        return ticketRepository.findByTituloIgnoreCaseContainingAndStatusAndPriorityOrderByDataDesc(titulo, status, priority, pageable);
    }
    ...
    public Page<Ticket> findByParametersAndCurrentUser(int page, int count, String titulo, String status, String priority, String idUsuario) {
        Pageable pageable = PageRequest.of(page,count);
        return ticketRepository.findByTituloIgnoreCaseContainingAndStatusAndPriorityAndUsuarioIdOrderByDataDesc(titulo, status, priority, pageable, idUsuario);
    }
    ...
    public Page<Ticket> findByParametersAndAssignedUser(int page, int count, String titulo, String status, String priority, String assignedUser) {
        Pageable pageable = PageRequest.of(page,count);
        return ticketRepository.findByTituloIgnoreCaseContainingAndStatusAndPriorityAndAssigneredUserIdOrderByDataDesc(titulo, status, priority, pageable,assignedUser);
    }
}
